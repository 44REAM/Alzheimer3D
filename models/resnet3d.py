# https://openaccess.thecvf.com/content_ICCV_2017_workshops/papers/w44/Hara_Learning_Spatio-Temporal_Features_ICCV_2017_paper.pdf
...
if __name__ == "__main__":
    ...
    model = generate_model(model_depth, inplanes, n_input_channels = 1,conv1_t_size = 5, conv1_t_stride=1, n_classes = 2)
